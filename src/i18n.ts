  ...
  he: {
    translation: {
      ...
      match: {
        ...
        live_chip: 'עכשיו בשידור חי', live_now: 'המשחק בעיצומו!',
        watch_live: 'לצפייה בלייב ב-WBPL TV',
        watch_live_note: 'הצפייה דרך אתר השידורים שלנו — הרשמה או התחברות, וצופים.',
      ...
      footer: {
        ...
        stats: 'סטטיסטיקה', vod: 'VOD', news: 'חדשות',
      ...
      notfound: {
        ...
        subtitle: 'יכול להיות שהקישור השתנה או שהעמוד הוסר. אפשר לחזור הביתה או לקפוץ ישר למשחקים.',
        home: 'לעמוד הבית',
        games: 'למשחקים ותוצאות',
      },
      common: {
  ...
  en: {
    translation: {
      ...
      match: {
        ...
        live_chip: 'LIVE', live_now: 'Game in progress!',
        watch_live: 'Watch live on WBPL TV',
        watch_live_note: 'Streaming on our broadcast site — sign up or log in, and watch.',
      ...
      footer: {
        ...
        stats: 'Statistics', vod: 'VOD', news: 'News',
      ...
      notfound: {
        ...
        subtitle: 'The link may have changed or the page was removed. Head home or jump straight to the games.',
        home: 'Home',
        games: 'Games & results',
      },
      common: {
